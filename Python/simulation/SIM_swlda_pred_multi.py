...
subset_total_num = 100

for subset_id in range(subset_total_num):
    ...
    swlda_predict_prob = SwLDATrain.swlda_predict_y_prob(
        b, inmodel, signals_trun
    )
    ...
    swlda_pred_test_dict = SwLDATest.ml_predict(
        ...
        LETTER_DIM, repet_num_pred,
    )
    SwLDATest.save_exist_ml_pred_results(
        swlda_pred_test_dict, repet_num_fit, repet_num_pred,
        LETTERS, method_name, scenario_name,
        'down_zeta_' + str(zeta_0),
